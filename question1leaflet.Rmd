...
data_HDI <- read_csv(paste0(path_bella,
                             "/HDI.csv"))
...
for (i in 1:nrow(data_HDI)){
  if(data_HDI$Y1990[i] == "..")
    data_HDI$Y1990[i] <- 0
}

count
data_HDI$status1990 <- "developed"
data_HDI$status2017 <- "developed"
for(i in 1:nrow(data_HDI)){
  if(data_HDI$Y1990[i] < 0.8)
    data_HDI$status1990[i] <- "developing"
  if(data_HDI$Y2017[i] < 0.8)
    data_HDI$status2017[i] <- "developing"
  if(data_HDI$Y1990[i] == 0)
    data_HDI$status1990[i] <- "no data"
  if(data_HDI$Y2017[i] == 0)
    data_HDI$status2017[i] <- "no data"
}
```
