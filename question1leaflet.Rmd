...
#I unfortunately can't make it to your office hours today ):
#Please take a look at line 300 and the leaflets made after that line!
#When I used 'bins3' for all of the palettes used for creating the leaflet
#the NA values didn't show up, but when I used a separate bin this error comes up.
#Thank you!
```
...
bins3 <- c(-Inf, -20, -15, -10, -5, 0, 5, 10, Inf)
bins4 <- c(0, 5, 10, 15, Inf)
pal1990_3 <- colorBin("Blues", domain = world_leaflet$Y1990, bins = bins4)
pal2017_3 <- colorBin("Blues", domain = world_leaflet$Y2017, bins = bins4)
palchange3 <- colorBin("Blues", domain = world_leaflet$change, bins = bins3)
